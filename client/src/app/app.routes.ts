...
import { OrderComponent } from './featuers/orders/order/order.component';
import { OrderDetailedComponent } from './featuers/orders/order-detailed/order-detailed.component';
